...
class GUI():
    def __init__(self,master):
        ...
        self.label = Label(text=":PASSWORD GENERATOR:", anchor=N, fg='black', bg='WHITE', font='arial 20 bold underline')
        ...
        self.user = Label(text="Enter Your Name: ", font='times 15 bold', bg='black', fg='darkgrey')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg='black', fg='darkgrey')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg='black', fg='darkgrey')
        ...
        self.generate = Button(text="GENERATE PASSWORD", bd=3, relief='solid', padx=1, pady=1, font='Verdana", 15 bold', fg='#68228B', bg='WHITE', command=self.generate_pass)
        ...
        self.reset = Button(text="RESET", bd=3, relief='solid', padx=1, pady=1, font='Helvetica 15 bold italic', fg='#458B00', bg='black', command=self.reset_fields)
