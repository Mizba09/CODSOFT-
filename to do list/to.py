...
class TaskManager:
    ...
    def create_widgets(self):
        ...
        self.task_field = Entry(
            self.functions_frame,
            font=("Georgia", "15"),
            width=42, fg="aqua", bg="white"
        )
        self.task_field.place(x=180, y=30)

        Button(
            self.functions_frame, text="You can Add", width=15,
            bg='#D4AC0D', font=("arial", "15", "bold"),
            command=self.add_task
        ).place(x=17, y=80)

        Button(
            self.functions_frame, text=" You can delete", width=15,
            bg='#D4AC0D', font=("arial", "15", "bold"),
            command=self.delete_task
        ).place(x=240, y=80)

        Button(
            self.functions_frame, text="Delete All to do list", width=15,
            bg='#D4AC0D', font=("arial", "15", "bold"),
